...
//<tag:items:bloodmagic:arc/tool>.add(<item:astralsorcery:infuser>);
<tag:blocks:forge:ores>.add(<block:feywild:fey_gem_block>);
<tag:blocks:forge:ores/fey_gem>.add(<block:feywild:fey_gem_block>);
<tag:items:forge:ores>.add(<item:feywild:fey_gem_block>);
<tag:items:forge:ores/fey_gem>.add(<item:feywild:fey_gem_block>);
<tag:items:forge:ores/vinteum>.add(<item:mana-and-artifice:vinteum_ore>);
<tag:blocks:forge:ores/vinteum>.add(<block:mana-and-artifice:vinteum_ore>);
<tag:items:forge:ores/rock_crystal>.add(<item:astralsorcery:rock_crystal_ore>);
<tag:blocks:forge:ores/rock_crystal>.add(<block:astralsorcery:rock_crystal_ore>);
<tag:items:forge:ores/inert>.add(<item:elementalcraft:crystalore>);
<tag:blocks:forge:ores/inert>.add(<block:elementalcraft:crystalore>);
<tag:items:forge:ores/moon_crystal>.add(<item:the_afterlight:overworld_moon_crystal_ore>);
<tag:blocks:forge:ores/moon_crystal>.add(<block:the_afterlight:overworld_moon_crystal_ore>);
<tag:blocks:forge:ores>.add(<block:the_afterlight:overworld_moon_crystal_ore>);
<tag:items:forge:ores>.add(<item:the_afterlight:overworld_moon_crystal_ore>);
<tag:blocks:forge:ores/luminis>.add(<block:buddycards:luminis_ore>);
<tag:items:forge:ores/luminis>.add(<item:buddycards:luminis_ore>);
<tag:blocks:forge:ores>.add(<block:buddycards:luminis_ore>);
<tag:items:forge:ores>.add(<item:buddycards:luminis_ore>);
<tag:items:forge:bread>.add(<item:buzzier_bees:honey_bread>, <item:upgrade_aquatic:mulberry_bread>, <item:autumnity:pumpkin_bread>, <item:the_bumblezone:bee_bread>, <item:create:sweet_roll>);
<tag:items:questtag:buddydisplay>.add(<item:buddycards:oak_card_display>, <item:buddycards:spruce_card_display>, <item:buddycards:birch_card_display>, <item:buddycards:jungle_card_display>, <item:buddycards:acacia_card_display>, <item:buddycards:dark_oak_card_display>, <item:buddycards:crimson_card_display>, <item:buddycards:warped_card_display>);
<tag:items:questtag:buddysteelvault>.add(<item:buddycards:buddysteel_vault.1>, <item:buddycards:buddysteel_vault.2>, <item:buddycards:buddysteel_vault.5>, <item:buddycards:buddysteel_vault.7>, <item:buddycards:buddysteel_vault.3>);
